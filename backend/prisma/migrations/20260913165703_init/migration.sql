...
-- CreateIndex
CREATE INDEX "BusinessLocation_countryCode_city_idx" ON "BusinessLocation"("countryCode", "city");
...
-- CreateIndex
CREATE INDEX "Product_businessLocationId_idx" ON "Product"("businessLocationId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_businessLocationId_slug_key" ON "Product"("businessLocationId", "slug");

-- CreateIndex
CREATE UNIQUE INDEX "Product_businessLocationId_sku_key" ON "Product"("businessLocationId", "sku");
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_businessLocationId_fkey" FOREIGN KEY ("businessLocationId") REFERENCES "BusinessLocation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
